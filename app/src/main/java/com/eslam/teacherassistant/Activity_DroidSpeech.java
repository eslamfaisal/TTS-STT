...
public class Activity_DroidSpeech extends Activity implements View.OnClickListener, OnDSListener, OnDSPermissionsListener
{
    ...
    public void onDroidSpeechSupportedLanguages(String currentSpeechLanguage, List<String> supportedSpeechLanguages)
    {
        ...
        if(supportedSpeechLanguages.contains("en"))
        {
            ...
            droidSpeech.setOneStepVerifyConfirmText("setOneStepVerifyConfirmText");
            droidSpeech.setOneStepVerifyRetryText("setOneStepVerifyRetryText");
        }
    }
